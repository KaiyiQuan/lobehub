export default {
  ...
  'heteroAgent.executionTarget.keepFilesTip':
    'Files the sandbox writes go to your persistent workspace: they survive the run and are shared across your topics, and with this on you pick the working directory or environment instance on the right. Off, a temporary working directory is used and cleaned up when the sandbox is recycled.',
