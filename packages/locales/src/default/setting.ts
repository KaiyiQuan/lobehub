...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'environments.files.newFile': 'New file',
  'environments.files.newDirectory': 'New folder',
  'environments.files.create': 'Create',
  'environments.files.filePlaceholder': 'notes.md',
  'environments.files.directoryPlaceholder': 'reports',
  'environments.files.save': 'Save',
  'environments.files.saved': 'Saved',
  'environments.files.remove': 'Delete',
  ...
  'environments.files.removeConfirmTitle': 'Delete {{name}}?',
