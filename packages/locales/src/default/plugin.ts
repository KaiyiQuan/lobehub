export default {
  ...
  'builtins.lobe-solver.apiName.solve.completed': 'Solved {{pack}}',
  'builtins.lobe-solver.apiName.solve.loading': 'Solving {{pack}} constraints',
  'builtins.lobe-solver.apiName.verify.completed': 'Plan verification',
  'builtins.lobe-solver.apiName.verify.loading': 'Verifying plan',
  'builtins.lobe-solver.inspector.conflicts': '{{count}} conflicts',
  'builtins.lobe-solver.inspector.status.error': 'spec error',
  'builtins.lobe-solver.inspector.status.feasibleTimeout': 'best within time limit',
  'builtins.lobe-solver.inspector.status.infeasible': 'infeasible',
  'builtins.lobe-solver.inspector.status.optimal': 'optimal',
  'builtins.lobe-solver.inspector.verifyFail': 'fail',
  'builtins.lobe-solver.inspector.verifyPass': 'pass',
  'builtins.lobe-solver.render.candidate': 'Candidate {{index}}',
  'builtins.lobe-solver.render.cost.accommodation': 'stay',
  'builtins.lobe-solver.render.cost.meals': 'meals',
  'builtins.lobe-solver.render.cost.transportation': 'transport',
  'builtins.lobe-solver.render.day': 'Day {{day}}',
  'builtins.lobe-solver.render.days': '{{count}} days',
  'builtins.lobe-solver.render.errorTitle': 'Spec validation failed',
  'builtins.lobe-solver.render.feasibleTimeoutNotice':
    'Best plan found within the {{ms}} ms time limit — optimality not proven',
  'builtins.lobe-solver.render.infeasibleTitle': 'No plan satisfies all constraints',
  'builtins.lobe-solver.render.itinerary': 'Day-by-day',
  'builtins.lobe-solver.render.overBudget': 'over budget',
  'builtins.lobe-solver.render.route': 'Route',
  'builtins.lobe-solver.render.satisfiedConstraints': 'Satisfied constraints',
  'builtins.lobe-solver.render.stay': 'Stay',
  'builtins.lobe-solver.render.suggestedRelaxations': 'Suggested relaxations',
  'builtins.lobe-solver.render.timeoutBadge': 'time-limited',
  'builtins.lobe-solver.render.transport': 'Transport',
  'builtins.lobe-solver.render.verifyFail': '{{failed}} of {{total}} checks failed',
  'builtins.lobe-solver.render.verifyPass': 'All checks passed ({{passed}}/{{total}})',
  'builtins.lobe-solver.render.withinBudget': 'within budget',
  'builtins.lobe-solver.title': 'Constraint Solver',
